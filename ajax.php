...
$dispatcher = patterns('',
    ...
    url('^/form/', patterns('ajax.forms.php:DynamicFormsAjaxAPI',
        ...
        url_post('^subjects', 'getSubjects'),
        url_post('^sla', 'getSla')


    )),

    url('^/call/',patterns('ajax.call.php:Call',
        url_get('^call', 'getCall'),
        url_post('^registercall', 'registerCall'),
        url_post('^uc/', 'updateCall'),
        url_post('^screechat', 'screenChat')
        //url_get('^uc/(\d+)?$', 'updateCall')
