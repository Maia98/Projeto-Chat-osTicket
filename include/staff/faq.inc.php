...
<form action="faq.php?<?php echo $qstr; ?>" method="post" id="save" enctype="multipart/form-data">
 ...
 <table class="form_table faq_form fixed" width="940" border="0" cellspacing="0" cellpadding="2">
    <thead>
    ...
    <tbody>
        ...
        <tr>
            <td colspan=2>
                <div><b><?php echo __('Category Listing');?></b>:&nbsp;<span class="faded"><?php echo __('FAQ category the question belongs to.');?></span>&nbsp;<span class="error">*&nbsp;<?php echo $errors['category_id']; ?></span></div>
        ...
        <tr>
            <td colspan=2>
                <div><b><?php echo __('Listing Type');?></b>:&nbsp;<span class="error">*<?php echo $errors['ispublished']; ?></span>
...
<p style="text-align:center;">
    ...
    <input type="reset"  class="btn btn-primary" name="reset"  value="<?php echo __('Reset'); ?>" onclick="javascript:
        $(this.form).find('textarea.richtext')
            .redactor('deleteDraft');
        location.reload();" />
    <input type="button" class="btn btn-primary" name="cancel" value="<?php echo __('Cancel'); ?>" onclick='window.location.href="faq.php?<?php echo $qstr; ?>"'>
</p>
</form>

<style>

    table.faq_form tr td{
        padding: 10px;
    }
