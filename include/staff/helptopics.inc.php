...
<div class="pull-right flush-right" style="padding-top:5px;padding-right:5px;">
    <b><a href="helptopics.php?a=add" class="Icon input-button input-button-primary"><?php echo __('Add New Help Topic');?></a></b></div>
<div class="clear"></div>
...
<input type="hidden" id="action" name="a" value="sort" >
    <div class="row" style="padding-right: 15px; padding-left: 15px">
        <div class="col-md-12" style="padding: 0 !important; margin-top: 10px;">
            <div class="pull-right sorting-mode"><?php echo __('Sorting Mode'); ?>:
                <select class="form-control" name="help_topic_sort_mode" onchange="javascript:
            ...
            <span class="pull-left span-allign"><?php
                echo $showing; ?>
            </span>
        </div>
    </div>
...
<p class="centered" id="actions">
    <button class="button btn btn-primary" style="color: #ffffff" type="submit" name="enable" value="Enable" ><?php echo __('Enable'); ?></button>
    <button class="button btn btn-warning" style="color: #ffffff" type="submit" name="disable" value="Disable"><?php echo __('Disable'); ?></button>
    <button class="button btn btn-danger" style="color: #ffffff" type="submit" name="delete" value="Delete"><?php echo __('Delete'); ?></button>
</p>
<?php
endif;
?>
