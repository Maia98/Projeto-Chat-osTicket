...
?>
<table width="100%" class="table-header" cellpadding="2" cellspacing="0" border="0">
    <tr>
        ...
        <td width="50%" class="right_align has_bottom_border">
            ...
            <a id="org-delete" class="responsive-buttons btn btn-primary btn-sm pull-right org-action"
        ...
        <td width="50%">
            <table border="0" cellspacing="" cellpadding="4" width="100%">
                <tr>
                    ...
                    <td nowrap><b><a href="#orgs/<?php echo $org->getId();
                ...
                <tr>
                    ...
                    <td nowrap><?php echo $org->getAccountManager(); ?>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td nowrap><?php echo Format::db_datetime($org->getUpdateDate()); ?></td>
                </tr>
            </table>
        </td>
    </tr>
...
<style>
    ...
    @media screen and (max-width: 450px) {
        ...
        table.table-header tr td span.responsive-buttons{
            width: 100%;
            display: block;
        }

        table.table-header tr td a#org-delete{
            width: 100%;
            display: block;
            margin-bottom: 10px;
            margin-top: 10px;
