...
<form action="canned.php" method="POST" name="canned">
    ...
    <div class="table-responsive">
        <div>
             ...
             <table class="table table-striped table-bordered" border="0" cellspacing="1" cellpadding="0" width="940">
            ...
            <div class="cold-md-4 col-md-offset-4">
                <p id="actions">
                    <input class="form-control button btn-primary" type="submit" name="enable" value="<?php echo __('Enable');?>" style="width: 110px; float: left; color: #ffffff; margin: 0px 0px 5px 5px;">
                    <input class="form-control button btn-primary" type="submit" name="disable" value="<?php echo __('Disable');?>" style="width: 110px; float: left; margin: 0px 0px 5px 5px; color: #ffffff;">
                    <input class="form-control button btn-primary" type="submit" name="delete" value="<?php echo __('Delete');?>" style="width: 110px; float: left; color: #ffffff; margin: 0px 0px 5px 5px;">
                </p>
            </div>
        </div>
        <?php
