...
<form action="directory.php" method="GET" name="filter">
    <div class="row">
        <div class="col-md-5">
            <input type="text" name="q" class="form-control" value="<?php echo Format::htmlchars($_REQUEST['q']); ?>" >
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-2 col-xs-12">
            <div class="input-group-btn"> 
                <button type="submit" class="btn btn-primary button-size" name="submit" value="<?php echo __('Filter');?>"><?php echo __('Pesquisar');?></button>
            </div>
        </div>
    </div>
</form>
...
<script>
    ...
    $("button[aria-label=Help]").click(function () {
