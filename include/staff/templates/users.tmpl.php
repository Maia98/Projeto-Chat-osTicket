...
<div class="buttons-responsive pull-right flush-right" style="padding-right:5px;">
    <b><a href="#orgs/<?php echo $org->getId(); ?>/add-user" class="btn btn-primary add-user"
        ><?php echo __('Add User'); ?></a></b>
    |
    <b><a href="#orgs/<?php echo $org->getId(); ?>/import-users" class="btn btn-primary add-user">
...
if ($res && $num) { //Show options..
    ...
    <p class="centered" id="actions">
        <input class="button btn btn-danger btn-sm" type="submit" name="remove-users" value="<?php echo __('Remove'); ?>" >
    </p>
<?php
}
?>
...
<script>
    ...
    if($(window).width() <= 450){
        $(".buttons-responsive").html("<b><a href=\"#orgs/<?php echo $org->getId(); ?>/add-user\" class=\"btn btn-primary add-user\"\n" +
            "        ><?php echo __('Add User'); ?></a></b>\n" +
            "    <b><a href=\"#orgs/<?php echo $org->getId(); ?>/import-users\" class=\"btn btn-primary add-user\">\n" +
            "    <?php echo __('Import'); ?></a></b>");
    }
    ...
    $(window).resize(function () {
        ...
        if($(this).width() <= 450){
            if($(".buttons-responsive").html().indexOf("|") > 0){
                $(".buttons-responsive").html("<b><a href=\"#orgs/<?php echo $org->getId(); ?>/add-user\" class=\"btn btn-primary add-user\"\n" +
                    "        ><?php echo __('Add User'); ?></a></b>\n" +
                    "    <b><a href=\"#orgs/<?php echo $org->getId(); ?>/import-users\" class=\"btn btn-primary add-user\">\n" +
                    "    <?php echo __('Import'); ?></a></b>");
