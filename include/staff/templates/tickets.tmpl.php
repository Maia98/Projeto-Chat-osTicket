...
<div class="pull-right flush-right" style="padding-right:5px;">
    <?php
    if ($user) { ?>
    <b><a class="btn btn-primary" href="tickets.php?a=open&uid=<?php echo $user->getId(); ?>" style="width: 100%">
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="2" width="100%">
    ...
    foreach($results as $row) {
        ...
        <tr id="<?php echo $row['ticket_id']; ?>">
            ...
            <td nowrap><a <?php if ($flag) { ?> class="Icon <?php echo $flag; ?>Ticket" title="<?php echo ucfirst($flag); ?> Ticket" <?php } ?>
            ...
            <td>
                <?php echo sprintf('<a href="users.php?id=%d">%s <em> &lt;%s&gt;</em></a>',
