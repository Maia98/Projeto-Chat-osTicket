...
?>
<h2 class="pull-left flush-left"><?php echo __('User Directory'); ?></h2>

<form action="users.php" method="get">
    <?php csrf_token(); ?>
    <input type="hidden" name="a" value="search">
        <div class="row" style="padding: 0px">
            <div class="col-md-4 col-xs-12 pull-right flush-right" style="padding-right:15px;"">
                <a class="btn btn-primary btn-sm popup-dialog" href="#users/add">
                    <i class="icon-plus-sign"></i>
                    <?php echo __('Add User'); ?>
                </a>
                <a class="btn btn-primary btn-sm popup-dialog" href="#users/import">
                    <i class="icon-upload"></i>
                    <?php echo __('Import'); ?>
                </a>
                <span class="btn btn-primary btn-sm" data-dropdown="#action-dropdown-more"
        ...
        <div class="pull-right flush-right" style="width: 100%; margin-top: 10px;">
            <input type="text" class="form-control" id="basic-user-search" name="query" value="<?php echo Format::htmlchars($_REQUEST['query']); ?>" autocomplete="off" autocorrect="off" autocapitalize="off">
            <input type="submit" name="basic_search" class="form-control btn btn-primary" value="<?php echo __('Search'); ?>">
        </div>
</form>
...
<div class="table-responsive">
     <table class="table table-striped table-bordered">
        ...
        <thead>
            <tr>
                <th align="left" width="100" align="center"> </th>
...
if($res && $num): //Show options..
    ...
    echo sprintf('<a class="btn btn-success no-pjax"
                href="users.php?a=export&qh=%s">'.__('Export').'</a>', $qhash);
