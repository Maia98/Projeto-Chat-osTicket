...
<form method="get" action="templates.php?">
    <h2><span><?php echo __('Email Template Set'); ?> &nbsp;/&nbsp; <span><a href="templates.php?tpl_id=<?php echo $tpl_id; ?>"><?php echo $name; ?></a></span></span></h2>
    <input type="hidden" name="a" value="manage">
            <input type="hidden" name="tpl_id" value="<?php echo $tpl_id; ?>">
<div class="row" style="margin-top: 10px;">
    <div class="col-md-1" style="padding-top: 10px;">
        <span style="font-size:10pt; display: inline-block"><?php echo __('Viewing'); ?>:</span>
    </div>
    <div class="col-md-4">
        <select class="form-control" id="tpl_options" name="id">
    ...
    <div class="col-md-1">
        <input type="submit" class="btn btn-primary" value="<?php echo __("Go"); ?>">
    </div>
</div>
</h2>
</form>
...
<h3 style="font-size:12pt;margin:0"><?php echo __($desc['name']); ?>
    ...
    <a style="font-size:10pt" class="tip pull-right hidden" href="#ticket_variables.txt">
    <i class="icon-tags"></i>
...
<p style="text-align:center">
    ...
    <input class="btn btn-primary" type="button" name="cancel" value="<?php echo __('Cancel Changes'); ?>"
