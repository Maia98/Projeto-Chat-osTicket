...
<div class="pull-right flush-right" style="padding-top:5px;padding-right:5px;">
    <b><a href="departments.php?a=add" class="Icon input-button input-button-primary"><?php echo __('Add New Department');?></a></b></div>
...
<p class="alinhamentoCenter">
    <input class="button btn btn-primary" type="submit" name="make_public" value="<?php echo __('Make Public');?>" >
    <input class="button btn btn-warning" type="submit" name="make_private" value="<?php echo __('Make Private');?>" >
    <input class="button btn btn-danger" type="submit" name="delete" value="<?php echo __('Delete Dept(s)');?>" >
</p>
<?php
endif;
?>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="full-width">
        <span class="buttons pull-left">
            <input type="button" value="<?php echo __('No, Cancel');?>" class="close btn btn-danger">
        </span>
