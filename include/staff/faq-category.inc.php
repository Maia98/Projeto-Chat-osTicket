...
if($thisstaff->canManageFAQ()) {
    echo sprintf('<div><a href="categories.php?id=%d" class="btn btn-primary">'.__('Edit Category').'</a>
             <a href="categories.php" class="btn btn-primary">'.__('Delete Category').'</a>
             <a href="faq.php?cid=%d&a=add" class="btn btn-primary">'.__('Add New FAQ').'</a></div>',
            $category->getId(),
            $category->getId());
} else {
?>
