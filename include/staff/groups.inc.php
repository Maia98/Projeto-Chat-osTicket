...
<div class="pull-right flush-right" style="padding-top:5px;padding-right:5px;">
    <b><a href="groups.php?a=add" class="Icon input-button input-button-primary"><?php echo __('Add New Group');?></a></b></div>
<div class="clear"></div>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="full-width">
        ...
        <span class="buttons pull-right">
            <input type="submit" value="<?php echo __('Yes, Do it!');?>" class="confirm btn btn-primary">
        </span>
     </p>
    <div class="clear"></div>
</div>
