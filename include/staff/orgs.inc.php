...
?>
<h2 class="pull-left flush-left"><?php echo __('Organizations'); ?></h2>
<form action="orgs.php" method="get">
    <?php csrf_token(); ?>
    <div class="division"></div>
    <input type="hidden" name="a" value="search">
    <div class="row" style="text-align: left;">
        <div class="col-md-3 col-xs-12 pull-right flush-right">
            <a class="btn btn-primary btn-sm popup-dialog add-org" href="#">
    ...
    <div class="pull-right flush-right" style="width: 100%; margin-top: 10px;">
        <input type="text" id="basic-org-search" class="form-control" name="query" value="<?php echo Format::htmlchars($_REQUEST['query']); ?>"
...
if($res && $num): //Show options..
    ...
    echo sprintf('<a class="btn btn-success no-pjax"
                href="orgs.php?a=export&qh=%s">'.__('Export').'</a>', $qhash);
