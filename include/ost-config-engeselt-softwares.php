...
define('SECRET_SALT','ce7f51bdc9c479b28ef73b6e7bfa6ef7');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','ti@engeselt.com.br');
...
define('DBNAME','helpdesk-software');
define('DBUSER','@tickets');
define('DBPASS','#]nhxd#I@@@F[');


# Table prefix
define('TABLE_PREFIX','ostau_');
