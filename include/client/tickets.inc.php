<?php
    ...
    $qselect='SELECT ticket.ticket_id, ticket.duedate, ostau_sla.name AS name_sla ,ticket.`number`,ticket.dept_id,isanswered, '
    ...
    $qfrom.=' LEFT JOIN '.TICKET_ATTACHMENT_TABLE.' attach ON  ticket.ticket_id=attach.ticket_id INNER JOIN ostau_sla ON ostau_sla.id = ticket.sla_id';
    ...
    <table class="table table-striped table-bordered" border="0" cellspacing="0" cellpadding="0">
        ...
        <thead>
            <tr>
                ...
                <th>
                    <a href="#" title="SLA"><?php echo __('SLA');?></a>
                </th>
                <th>
                ...
                <th>
                    <a href="#" title="Data de Vencimento"><?php echo __('Due Date');?></a>
                </th>
            </tr>
        </thead>
            <tbody>
                 ...
                 if($res && ($num=db_num_rows($res))) {
                    ...
                    while ($row = db_fetch_array($res)) {
                        ...
                        <tr id="<?php echo $row['ticket_id']; ?>">
                            ...
                            <td>&nbsp;<?php
                                if($row['duedate']) {
                                    echo Format::db_datetime($row['duedate']);
                                }else {
                                    echo 'Sem Vencimento';
                                }  ?></td>
                        </tr>
